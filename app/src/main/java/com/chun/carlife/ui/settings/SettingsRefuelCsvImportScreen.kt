...
@Composable
fun SettingsRefuelCsvImportScreen(onBack: () -> Unit) {
    ...
    SettingsScaffold(title = "CSV インポート", onBack = onBack) { padding ->
        Column(
            modifier = Modifier
                .fillMaxSize()
                .padding(padding)
            ...
            if (result != null) {
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            "結果: ${result.added} 件追加 / ${result.skipped} 件スキップ",
